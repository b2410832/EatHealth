  ...
  return (
    <div className={styles.stepsContainer}>
      <div className={styles.text}>
        步驟<span>（至少一個步驟，步驟照片為選擇性上傳）</span>
      </div>
        ...
        return (
          <div className={styles.step} key={step.uid}>
            <div className={styles.upload}>
              <div className={styles.imageContainer}>
                <img
                  ...
                  onLoad={() => clearMemory(step.uid)}
                ></img>
              </div>
              <label htmlFor={step.uid} className={styles.label}>
                點擊上傳步驟照片
              </label>
              <input
                type="file"
                accept="image/*"
                onChange={(e) => handleFile(e, step.uid)}
            ...
            <div className={styles.content}>
              ...
              <textarea
                placeholder="請輸入步驟說明（必填）"
                value={step.text}
                onChange={(e) => handleTextChange(e, step.uid)}
              ></textarea>
            </div>
            {showDeleteModal && (
              <Modal
      ...
      <button className={styles.button} onClick={addStep}>
        + 新增步驟
      </button>
    </div>
  );
